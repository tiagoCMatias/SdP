export function calcularLateraisConica(lateral, estrutura) {
  ...
  if (lateral.opaco > 0) {
    laterais.push({
      qt: lateral.opaco,
      title: "Conica Lateral Opaco*" + estrutura.tamanho,
      codigo: ""
    });
  }
  if (lateral.transparente > 0) {
    laterais.push({
      ...
      title: "Conica Lateral Transparente*" + estrutura.tamanho,
      codigo: ""
    });
  }
  if (lateral.blackout > 0) {
    laterais.push({
      qt: lateral.blackout,
      title: "Conica Lateral Blackout*" + estrutura.tamanho,
      codigo: ""
    });
  }
...
export function calcularCoberturaConica(cobertura, estrutura) {
  return {
    qt: 1,
    title: "Cobertura Conica - " + cobertura + '*' + estrutura.tamanho,
    codigo: 'x'
  };
}
...
export function calcularEstruturaConica(tenda) {
  ...
  let componentes = [{
      qt: 4,
      title: 'Pé Conica ' + tenda.tamanho + '*' + tenda.tamanho,
      codigo: '1'
    },
    {
      qt: 4,
      title: 'Viga Conica ' + tenda.tamanho + '*' + tenda.tamanho,
      codigo: '2'
    },
    {
      qt: 4,
      title: 'Diagonal ' + tenda.tamanho + '*' + tenda.tamanho,
      codigo: '3'
    },
    {
      qt: 4,
      title: 'Ferro esticar lateral ' + tenda.tamanho + '*' + tenda.tamanho,
      codigo: '4'
    },
    {
      qt: 1,
      title: 'Cone ' + tenda.tamanho + '*' + tenda.tamanho,
      codigo: '5.1'
    },
    {
      qt: 1,
      title: 'Ferro do Cone ' + tenda.tamanho + '*' + tenda.tamanho,
      codigo: '5.2'
    },
    {
      qt: 1,
      title: 'Cruzeta ' + tenda.tamanho + '*' + tenda.tamanho,
      codigo: '5.3'
    },
    {
      qt: 4,
      title: 'Parafusos M12 80',
      codigo: '5.4'
    },
    {
      qt: 4,
      title: 'Chapa Fixação Ferro Lateral',
      codigo: '5.5'
    },
    {
      qt: 8,
