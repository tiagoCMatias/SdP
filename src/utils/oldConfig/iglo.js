...
export function CoberturaIglo(tenda) {
  ...
  if (tenda.cobertura_opaco > 0) {
    cobertura.push({
      qt: tenda.cobertura_opaco,
      title: "Cobertura Opaco Iglo*" + tenda.largura,
      codigo: 'x'
    });
  }
  if (tenda.cobertura_transparent > 0) {
    cobertura.push({
      qt: tenda.cobertura_transparent,
      title: "Cobertura Transparente Iglo*" + tenda.largura,
      codigo: 'x'
    });
  }
  if (tenda.cobertura_blackout > 0) {
    cobertura.push({
      qt: tenda.cobertura_blackout,
      title: "Cobertura Blackout Iglo*" + tenda.largura,
      codigo: 'x'
    });
  }
  if (tenda.cobertura_especial != null) {
    cobertura.push({
      qt: 1,
      title: "Cobertura " + tenda.cobertura_especial + " Iglo*" + resto,
      codigo: 'x'
    });
  }
...
export function LateraisIglo(tenda) {
  ...
  if (tenda.lateral_opaco > 0) {
    ...
    lateral.push({
      qt: tenda.lateral_opaco,
      title: "Lateral Opaco Iglo*" + tenda.largura,
      codigo: 'x'
    });
  }
  if (tenda.lateral_transparente > 0) {
    ...
    lateral.push({
      qt: tenda.lateral_transparente,
      title: "Lateral Transparente Iglo*" + tenda.largura,
      codigo: 'x'
    });
  }
  if (tenda.lateral_blackout > 0) {
    ...
    lateral.push({
      qt: tenda.lateral_blackout,
      title: "Lateral Blackout Iglo*" + tenda.largura,
      codigo: 'x'
    });
  }
  if (tenda.lateral_especial_1 != null) {
    lateral.push({
      qt: 1,
      title: "Lateral " + tenda.lateral_especial_1 + " Iglo*" + resto,
      codigo: 'x'
    });
  }
  if (tenda.lateral_especial_2 != null) {
    lateral.push({
      qt: 1,
      title: "Lateral " + tenda.lateral_especial_2 + " Iglo*" + resto,
      codigo: 'x'
    });
  }
  ...
  if (tenda.tipo_topo_1 == "Direito") {
    lateral.push({
      qt: 1,
      title: "Lateral de Angulo Direito " + tenda.lateral_direito_1 + " Iglo*" + tenda.largura,
      codigo: 'x'
    }, {
      qt: 1,
      title: "Lateral de Angulo Esquerdo " + tenda.lateral_esquerdo_1 + " Iglo*" + tenda.largura,
      codigo: 'x'
    });
  }
  if (tenda.tipo_topo_2 == "Direito") {
    lateral.push({
      qt: 1,
      title: "Lateral de Angulo Direito " + tenda.lateral_direito_2 + " Iglo*" + tenda.largura,
      codigo: 'x'
    }, {
      qt: 1,
      title: "Lateral de Angulo Esquerdo " + tenda.lateral_esquerdo_2 + " Iglo*" + tenda.largura,
      codigo: 'x'
    });
  }
  if (tenda.lateral_topo_redondo_1 != null) {
    lateral.push({
      qt: (tenda.largura / 5) + 2,
      title: "Lateral Topo Redondo " + tenda.lateral_topo_redondo_1 + " Iglo*" + tenda.largura,
      codigo: 'x'
    }, {
      qt: (tenda.largura / 5) + 2,
      title: "Ferro Esticar Topo Redondo Iglo*" + tenda.largura,
      codigo: 'x'
    });
  }
  if (tenda.lateral_topo_redondo_2 != null) {
    lateral.push({
      qt: (tenda.largura / 5) + 2,
      title: "Lateral Topo Redondo " + tenda.lateral_topo_redondo_2 + " Iglo*" + tenda.largura,
      codigo: 'x'
    }, {
      qt: (tenda.largura / 5) + 2,
      title: "Ferro Esticar Topo Redondo Iglo*" + tenda.largura,
...
function calcularTopoDireitoIglo(tenda) {
  ...
  if (tenda.triangulo_1 != null) {
    topo.push({
      qt: 1,
      title: 'Triangulo Topo Direito ' + tenda.triangulo_1 + ' Iglo*' + tenda.largura,
      codigo: ''
    });
  }
  if (tenda.triangulo_2 != null) {
    topo.push({
      qt: 1,
      title: 'Triangulo Topo Direito ' + tenda.triangulo_2 + ' Iglo*' + tenda.largura,
      codigo: ''
    });
  }
  if (tenda.largura >= 15) {
...
function calcularTopoRedondo(tenda) {
  ...
  if (tenda.bacalhau_transparente > 0) {
    topo.push({
      qt: tenda.bacalhau_transparente,
