  ...
  methods: {
    ...
    estrutura_iglo: function() {
        if (this.$refs.form_estrutura.validate()) {
            //calcularIglo(estrutura);
            this.mySlider = 2;
            this.resto = this.estrutura.comprimento%5;
            this.max_topo = 0;
            let modulos_5 = 0;
            let raio = (this.estrutura.largura/2);
            let new_comprimento = this.estrutura.comprimento;
            let laterais_topo = 0;

            if(this.estrutura.tipo_topo_1 == "Redondo")
            {
                new_comprimento -= raio;
                this.max_topo += (this.estrutura.largura/5)+2;
                laterais_topo += (this.estrutura.largura/5)*2;

            }
            if(this.estrutura.tipo_topo_2 == "Redondo")
            {
                new_comprimento -= raio;
                this.max_topo += (this.estrutura.largura/5)+2;
                laterais_topo += (this.estrutura.largura/5)*2;
            }
            if(this.estrutura.tipo_topo_2 == "Redondo" || this.estrutura.tipo_topo_1 == "Redondo")
            {
            ...
            {
                this.resto = new_comprimento%5;
                modulos_5 = Math.floor(this.estrutura.comprimento/5);
                this.max_laterais = (modulos_5*2);
            }

            if(this.estrutura.tipo_topo_1 == "Direito")
            {
                this.max_laterais += this.estrutura.largura/5;
                this.max_laterais -= 2 ;
            }
            if(this.estrutura.tipo_topo_2 == "Direito")
            {
                this.max_laterais += this.estrutura.largura/5;
                this.max_laterais -= 2 ;
            }
            ...
            if(this.estrutura.comprimento == this.estrutura.largura && (this.estrutura.tipo_topo_1 == "Redondo" && this.estrutura.tipo_topo_2 == "Redondo"))
                return;
            let resposta = EstruturaIglo(this.estrutura);
    ...
    cobertura_iglo: function() {
        ...
        if(this.estrutura.comprimento == this.estrutura.largura && (this.estrutura.tipo_topo_1 == "Redondo" && this.estrutura.tipo_topo_2 == "Redondo"))
            return;
        let resposta = CoberturaIglo(this.estrutura);
        console.log(resposta);
        resposta.forEach(element => {
            this.items.push({
                codigo: "1.1." + this.estrutura.largura + "." + element.codigo,
    ...
    lateraisIglo: function() {
        console.log("Opaco: " + this.estrutura.lateral_opaco);
        console.log("Transparente: " + this.estrutura.lateral_transparente);
        console.log("Blackout: " + this.estrutura.lateral_blackout);

        this.mySlider = 4;
        if(this.estrutura.comprimento == this.estrutura.largura && (this.estrutura.tipo_topo_1 == "Redondo" && this.estrutura.tipo_topo_2 == "Redondo"))
                return;
        let resposta = LateraisIglo(this.estrutura);
        resposta.forEach(element => {
            this.items.push({
                codigo: "1.1." + this.estrutura.largura + "." + element.codigo,
                title: element.title,
    ...
    trianguloIglo: function() {
        ...
        {
            let resposta = calcularTopoIglo(this.estrutura);
            console.log("Update");
            resposta.forEach(element => {
                this.items.push({
                    codigo: "1.1." + this.estrutura.largura + "." + element.codigo,
