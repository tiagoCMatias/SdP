        ...
        .then(component => {
          component.data.forEach(myComponent => {
            ...
            myComponent.pertence.forEach(element => {
              tagTenda +=
                "[" +
                this.listaTendas.find(v => v["id"] === element.tenda.id).tag +
                "] ";
            });
            this.tabelaItens.push({
              ...
              familia: this.listaFamilia.find(
                v => v["id"] === myComponent.familia
              ).nome,
              tendas: tagTenda,
